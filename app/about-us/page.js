    ...
    mission: {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-base md:text-lg">With PrepWise AI, the goal is to bridge the gap between preparation and success, empowering users to unlock their full potential.</p>
        </div>
      )
    },
    story: {
