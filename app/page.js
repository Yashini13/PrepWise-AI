    ...
    <div className="space-y-2">
      {links.map((link, index) => (
        <a
          ...
          className="group flex items-center text-purple-600 hover:text-indigo-800 transition-colors"
        >
          {link.name}
          <ArrowRight
              ...
              {[
                {
                  ...
                  icon: <Book className="w-12 h-12 text-purple-600 mx-auto mb-4" />,
                ...
                >
                  ...
                  <a
                    href={tip.url}
                    onClick={(e) => {
                      if (tip.title === "Skill Assessment") {
                        e.preventDefault();
                        alert("If you have not previously logged in you will be shown dummy data. Kindly Login In to let PrepWise AI assist you");
                        // Delay navigation to ensure alert shows
                        setTimeout(() => {
                          window.location.href = tip.url;
                        }, 100);
                      }
                    }}
                    className="group-hover:text-indigo-800 text-purple-600 flex items-center justify-center cursor-pointer"
                  >
                    Explore
